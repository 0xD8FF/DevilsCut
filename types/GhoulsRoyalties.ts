...
export interface GhoulsRoyaltiesInterface extends utils.Interface {
  functions: {
...
export interface GhoulsRoyalties extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GhoulsRoyaltiesInterface;
